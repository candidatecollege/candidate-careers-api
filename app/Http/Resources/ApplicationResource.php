...
class ApplicationResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'reason' => $this->reason,
            'leadership experience(s)' => $this->leadership_experience,
            'skill experience(s)' => $this->skill_experience,
            'busyness' => $this->busyness,
            'commitment value' => $this->commitment_value,
            'reason of commitment value' => $this->reason_commitment_value,
            'CV' => $this->cv,
            'portfolio' => $this->portfolio,
            'is available for unpaid?' => $this->avaliableForUnpaid($this->is_available_for_unpaid),
